// Zaj03_4.cpp : Defines the entry point for the console application.
//
...
void GenerateDisplayLists()
{
	...
	glTexCoord2f(0.0, 1.0);
	glVertex3f(0.75 - 1, -0.75, 1.0);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(0.25 - 1, -0.75, 1.0);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(0.25 - 1, -0.25, 1.0);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(0.75 - 1, -0.25, 1.0);

	glTexCoord2f(0.0, 1.0);
	glVertex3f(0.75, -0.75 - 1, 1.0);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(0.25, -0.75 - 1, 1.0);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(0.25, -0.25 - 1, 1.0);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(0.75, -0.25 - 1, 1.0);

	glTexCoord2f(0.0, 1.0);
	glVertex3f(0.75 - 1, -0.75 - 1, 1.0);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(0.25 - 1, -0.75 - 1, 1.0);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(0.25 - 1, -0.25 - 1, 1.0);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(0.75 - 1, -0.25 - 1, 1.0);
	...
	glTexCoord2f(0.0, 1.0);
	glVertex3f(1, -0.75, -0.75);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(1, -0.25, -0.75);
	glTexCoord2f(1.0, 0.0);
	...
	glTexCoord2f(0.0, 1.0);
	glVertex3f(1, -0.75 - 1, -0.75);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(1, -0.25 - 1, -0.75);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(1, -0.25 - 1, -0.25);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1, -0.75 - 1, -0.25);

	glTexCoord2f(0.0, 1.0);
	glVertex3f(1, -0.75, -0.75 + 1);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(1, -0.25, -0.75 + 1);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(1, -0.25, -0.25 + 1);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1, -0.75, -0.25 + 1);

	glTexCoord2f(0.0, 1.0);
	glVertex3f(1, -0.75 - 1, -0.75 + 1);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(1, -0.25 - 1, -0.75 + 1);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(1, -0.25 - 1, -0.25 + 1);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1, -0.75 - 1, -0.25 + 1);
