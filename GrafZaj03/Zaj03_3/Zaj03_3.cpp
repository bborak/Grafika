...
void GenerateTextures()
{
	...
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku plu0rss1.tga");
		exit(0);
	}
	...
	// wczytanie tekstury Merkury utworzonej ze zdjęć sond Viking
	// plik: http://maps.jpl.nasa.gov/pix/mer0muu2.tif
...
int main(int argc, char *argv[])
{
	...
	glutAddMenuEntry("PLUTON", VENUS_TEX);
	glutAddMenuEntry("Ziemia", EARTH_TEX);
	glutAddMenuEntry("Merkury", MARS_TEX);
